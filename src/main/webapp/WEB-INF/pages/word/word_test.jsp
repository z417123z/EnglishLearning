...
<div class="page-content">
	<%--<form id="wordForm" class="form-inline" action="<%=path%>/word/wordTestPage?bookId=${bookId}" method="post">
			...
			<div class="panel-body">
				<div class="pull-left">
					...
					<div class="form-group qinfo">
						...
						<input type="text" name="rows" id="rows" value="${rows}"/>
					</div>
		...
		<nav aria-label="Page navigation">
			<ul class="pagination">
				<c:if test="${pageInfo.hasPreviousPage}">
					<li>
						<a href="${pageContext.request.contextPath}/word/wordTestPage?page=${pageInfo.prePage}&rows=${pageInfo.pageSize}
				...
				<c:forEach items="${pageInfo.navigatepageNums}" var="nav">
					...
					<c:if test="${nav != pageInfo.pageNum}">
						<li>
							<a href="${pageContext.request.contextPath}/word/wordTestPage?page=${nav}&rows=${pageInfo.pageSize}
				...
				<c:if test="${pageInfo.hasNextPage}">
					<li>
						<a href="${pageContext.request.contextPath}/word/wordTestPage?page=${pageInfo.nextPage}&rows=${pageInfo.pageSize}
