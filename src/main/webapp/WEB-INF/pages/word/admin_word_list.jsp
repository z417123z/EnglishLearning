		...
		<nav aria-label="Page navigation">
			<ul class="pagination">
				<c:if test="${pageInfo.hasPreviousPage}">
					<li>
						<a href="${pageContext.request.contextPath}/word/adminWords?page=${pageInfo.prePage}&rows=${pageInfo.pageSize}
				...
				<c:forEach items="${pageInfo.navigatepageNums}" var="nav">
					...
					<c:if test="${nav != pageInfo.pageNum}">
						<li>
							<a href="${pageContext.request.contextPath}/word/adminWords?page=${nav}&rows=${pageInfo.pageSize}
				...
				<c:if test="${pageInfo.hasNextPage}">
					<li>
						<a href="${pageContext.request.contextPath}/word/adminWords?page=${pageInfo.nextPage}&rows=${pageInfo.pageSize}
