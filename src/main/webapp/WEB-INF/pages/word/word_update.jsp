...
<div class="page-content">
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<form action="<%=path%>/word/updateWord?id=${word.id}" method="post" id="addForm">
							...
							<div class="form-group">
								...
								<div class="col-sm-9 form-inline">
									<input id="name" name="name" size="35" class="form-control"
										   type="text" value="${word.name}" tip="请输入用户名" />
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row rowmargin">
						<div class="col-sm-7">
							<div class="form-group">
								...
								<div class="col-sm-9 form-inline">
									<%--<textarea rows="5" cols="80" id="translation" name="translation"  maxlength="500"
											  class="form-control" value="${word.translation}"></textarea>--%>

									<input id="translation" name="translation" size="35" class="form-control"
										   type="text" value="${word.translation}" tip="请输入姓名" />
								</div>
							</div>
						</div>
					</div>
