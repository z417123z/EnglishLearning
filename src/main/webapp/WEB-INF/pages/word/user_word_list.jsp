...
<div class="page-content">
	<form id="wordForm" class="form-inline" action="<%=path%>/word/wordPage?bookId=${bookId}" method="post">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="pull-right">
					...
					<button type="button" id="selfTest" class="btn btn-info">
						开始自测</button>
				</div>
			</div>
		</div>
...
<script type="text/javascript">
	$(document).ready(function(){
		$("#selfTest").click(function(){
			window.location.href = '<%=path%>/word/userWordTest?bookId=${bookId}';
		});
	});
	$(document).ready(function() {
