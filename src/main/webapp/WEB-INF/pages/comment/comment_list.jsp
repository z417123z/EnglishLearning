...
<div class="page-content">
	<form action="<%=path%>/comment/toQueryContentList" class="form-inline"
		  method="post">
				...
				<nav aria-label="Page navigation">
					<ul class="pagination">
						<c:if test="${pageInfo.hasPreviousPage}">
							<li>
								<a href="${pageContext.request.contextPath}/comment/list?page=${pageInfo.prePage}&rows=${pageInfo.pageSize}
									&name=${queryParam.user_name}" aria-label="Previous">
						...
						<c:forEach items="${pageInfo.navigatepageNums}" var="nav">
							...
							<c:if test="${nav != pageInfo.pageNum}">
								<li>
									<a href="${pageContext.request.contextPath}/comment/list?page=${nav}&rows=${pageInfo.pageSize}
										&name=${queryParam.user_name}">${nav}</a>
								</li>
							</c:if>
						</c:forEach>
						<c:if test="${pageInfo.hasNextPage}">
							<li>
								<a href="${pageContext.request.contextPath}/comment/list?page=${pageInfo.nextPage}&rows=${pageInfo.pageSize}
									&name=${queryParam.user_name}" aria-label="Next">
