				...
				<div class="row rowmargin">
					<div class="col-sm-7">
						<div class="form-group">
							...
							<div class="col-sm-9 form-inline">
								<input id="adminName" name="adminName" size="35" value="${comment.admin_name}"
				...
				<div class="row rowmargin">
					<div class="col-sm-7">
						<div class="form-group">
							...
							<div class="col-sm-9 form-inline">
										<textarea rows="5" readonly="readonly" cols="80" id="rcontent"
												  name="rcontent" class="form-control" tip="请输入回复内容">${comment.content}</textarea>
							</div>
						</div>
					</div>
				</div>
