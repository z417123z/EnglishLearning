			...
			<table class="table table-striped table-hover"
				...
				<c:forEach items="${pageInfo.list}" var="comment">
					<tr>
						...
						<td>
								<a href="<%=path%>/comment/userHideContent?id=${comment.id}"
				...
				<nav aria-label="Page navigation">
					<ul class="pagination">
						<c:if test="${pageInfo.hasPreviousPage}">
							<li>
								<a href="${pageContext.request.contextPath}/comment/userList?page=${pageInfo.prePage}"
								   aria-label="Previous">
						...
						<c:forEach items="${pageInfo.navigatepageNums}" var="nav">
							...
							<c:if test="${nav != pageInfo.pageNum}">
								<li>
									<a href="${pageContext.request.contextPath}/comment/userList?page=${nav}">${nav}</a>
								</li>
							</c:if>
						</c:forEach>
						<c:if test="${pageInfo.hasNextPage}">
							<li>
								<a href="${pageContext.request.contextPath}/comment/userList?page=${pageInfo.nextPage}"
								   aria-label="Next">
