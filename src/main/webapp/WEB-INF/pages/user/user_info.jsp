									...
									<div class="form-group">
										...
										<div class="col-sm-9 form-inline">
											<input id="id" name="id" size="35" readonly="readonly"
												class="form-control" type="text" value="${user.id}"
												/>
										</div>
									</div>
								</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9 form-inline">
											<input id="username" name="username" size="35" class="form-control" readonly="readonly"
												type="text" value="${user.username}" tip="请输入账号" />
										</div>
									</div>
								</div>
							</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9 form-inline">
											<input id="password" name="password" size="35" class="form-control"
												type="password" value="${user.password}" tip="请输入密码" />
										</div>
									</div>
								</div>
							</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9 form-inline">
											<select id="grade" name="grade" class="form-control">
												<option <c:if test="${user.grade=='高中'}">selected</c:if>
														value="高中">
													高中
												</option>
												<option <c:if test="${user.grade=='大学'}">selected</c:if>
														value="大学">
													大学
												</option>
											</select>
