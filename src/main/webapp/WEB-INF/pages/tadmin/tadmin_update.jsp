	...
	<div class="page-content">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="<%=path%>/admin/update" method="post" id="addForm">
							...
							<div class="col-sm-7">
								<div class="form-group">
									...
									<div class="col-sm-9 form-inline">
										<input id="username" name="username" readonly="readonly" size="35" class="form-control" type="text" value="${admin.username}" tip="请输入用户名" />
									</div>
								</div>
							</div>
						</div>
						<div class="row rowmargin">
							<div class="col-sm-7">
								<div class="form-group">
									...
									<div class="col-sm-9 form-inline">
										<input id="password" name="password" size="35" class="form-control" type="password" value="${admin.password}" tip="请输入密码" />
									</div>
								</div>
							</div>
						</div>
						...
						<div class="row rowmargin">
							<div class="col-sm-7">
								<div class="form-group">
									...
									<div class="col-sm-9 form-inline">
										<input id="tel" name="tel" size="35" class="form-control" type="text"
											   value="${admin.tel}" tip="请输入联系电话" />
									</div>
								</div>
							</div>
						</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9 form-inline">
										 <select  name="type" class="form-control">
										    <option <c:if test="${admin.type=='管理员'}">selected</c:if> value="普通管理员">
												普通管理员</option>
										    <option <c:if test="${admin.type=='超管'}">selected</c:if> value="超级管理员">
												超级管理员</option>
										 </select>
									</div>
								</div>
