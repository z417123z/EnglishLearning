						...
						<div class="col-sm-7">
							<div class="form-group">
								...
								<div class="col-sm-9 form-inline">
									<input id="username" name="username" size="35" value="${admin.username}" readonly="readonly" class="form-control" type="text" />
								</div>
							</div>
						</div>
					</div>
					<div class="row rowmargin">
						<div class="col-sm-7">
							<div class="form-group">
								...
								<div class="col-sm-9 form-inline">
									<input id="password" name="password" size="35" value="${admin.password}" readonly="readonly" class="form-control" type="text" />
								</div>
							</div>
						</div>
					</div>
					<div class="row rowmargin">
						<div class="col-sm-7">
							<div class="form-group">
								...
								<div class="col-sm-9 form-inline">
									<input id="name" name="name" size="35" value="${admin.name}" readonly="readonly" class="form-control" type="text" />
								</div>
							</div>
						</div>
					</div>
					<div class="row rowmargin">
						<div class="col-sm-7">
							<div class="form-group">
								...
								<div class="col-sm-9 form-inline">
									<input id="tel" name="tel" size="35" value="${admin.tel}" readonly="readonly" class="form-control" type="text" />
								</div>
							</div>
						</div>
					</div>
